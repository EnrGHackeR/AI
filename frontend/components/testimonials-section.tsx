      ...
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-16">
          <TypewriterHeading
            ...
            tag="h2"
            className="text-4xl md:text-5xl font-normal leading-tight font-serif text-[#36B1C7]"
            typeSpeed={40}
          />
        </div>
        ...
        <div className="space-y-6">
          ...
          <div className="relative">
            <div className="absolute left-0 top-0 bottom-0 w-32 bg-gradient-to-r from-[#0F0F14] to-transparent z-10 pointer-events-none" />
            <div className="absolute right-0 top-0 bottom-0 w-32 bg-gradient-to-l from-[#0F0F14] to-transparent z-10 pointer-events-none" />
            ...
            >
              {duplicatedTestimonials.map((testimonial, index) => (
                <div
                  key={index}
                  className="flex-shrink-0 w-full sm:w-[400px] rounded-2xl p-8 py-4 card-gradient"
                >
                  <div className="flex items-start gap-4 mb-6">
                    ...
                    />
                    <p className="text-[#FBF6EE] leading-relaxed flex-1 text-lg">
                      &ldquo;{testimonial.content}&rdquo;
                    </p>
                  </div>
                  <div className="mt-auto">
                    <p className="text-[#D3AF37] text-sm font-bold">{testimonial.name}</p>
                    <p className="text-[#E8D8C3]/50 text-xs">{testimonial.role}</p>
                  </div>
                </div>
              ))}
            </div>
                ...
                >
                  <div className="flex items-start gap-4 mb-6">
                    <Image
                      ...
                      className="w-12 h-12 rounded-full object-cover"
                    />
                    <p className="text-lg text-[#FBF6EE] leading-relaxed flex-1">
                      &ldquo;{testimonial.content}&rdquo;
                    </p>
                  </div>
                  <div className="mt-auto">
                    <p className="text-[#D3AF37] text-sm font-bold">{testimonial.name}</p>
                    <p className="text-sm text-[#E8D8C3]/50">{testimonial.role}</p>
                  </div>
                </div>
              ))}
            </div>
