    ...
    <section id="stats-section" className="py-24 px-6">
      <div className="max-w-4xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 lg:gap-16">
          ...
          >
            <p className="font-light text-[#FBF6EE] mb-2 text-6xl md:text-7xl leading-none">{homes.value}</p>
          ...
          >
            <p className="font-light text-[#FBF6EE] mb-2 text-6xl md:text-7xl leading-none">{cities.value}</p>
            <p className="text-xs text-[#E8D8C3]/60 uppercase tracking-wider">Cities</p>
          </div>

          <div
            className={`text-center transition-all duration-1000 delay-400 ${isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"}`}
          >
            <p className="font-light text-[#FBF6EE] mb-2 text-6xl md:text-7xl leading-none">{users.value}</p>
