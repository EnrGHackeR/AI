    ...
    <section className="pt-32 pb-12 px-6 min-h-screen flex items-center relative overflow-hidden">
      <div className="absolute inset-0 top-0">
        ...
        >
          ...
          {/* Dark overlay for better text readability on dark theme */}
          <div className="absolute inset-0 bg-gradient-to-b from-[#0F0F14]/60 via-transparent to-[#0F0F14]/80" />
        </div>
      </div>
      ...
      >
        <span
          className="block text-white/90 font-bold text-[28vw] sm:text-[25vw] md:text-[22vw] lg:text-[20vw] tracking-tighter select-none text-center leading-none"
          style={{ marginBottom: "0", textShadow: "0 0 60px rgba(54, 177, 199, 0.3)" }}
        >
          HOMIE
        </span>
      </div>
        ...
        <div className="text-center mb-12">
          ...
          >
            <TypewriterHeading
              ...
              tag="h1"
              className="font-serif text-[3.5rem] sm:text-[4.5rem] md:text-[5.5rem] lg:text-[6.5rem] xl:text-[7.5rem] 2xl:text-[8.5rem] font-normal leading-tight mb-6 w-full px-4 max-w-6xl mx-auto text-balance text-[#36B1C7]"
              typeSpeed={50}
              startDelay={1000}
            />
          </div>
